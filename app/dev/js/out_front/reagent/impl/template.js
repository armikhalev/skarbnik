...
var G__8471 = o;
(G__8471[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__8472__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__8472 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__8473__i = 0, G__8473__a = new Array(arguments.length -  0);
while (G__8473__i < G__8473__a.length) {G__8473__a[G__8473__i] = arguments[G__8473__i + 0]; ++G__8473__i;}
  args = new cljs.core.IndexedSeq(G__8473__a,0);
} 
return G__8472__delegate.call(this,args);};
G__8472.cljs$lang$maxFixedArity = 0;
G__8472.cljs$lang$applyTo = (function (arglist__8474){
var args = cljs.core.seq(arglist__8474);
return G__8472__delegate(args);
});
...
var G__8480 = jsprops;
(G__8480["defaultValue"] = value);

(G__8480["onChange"] = ((function (G__8480,v,value,on_change){
return (function (p1__8477_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8477_SHARP_);
});})(G__8480,v,value,on_change))
);

(G__8480["ref"] = ((function (G__8480,v,value,on_change){
return (function (p1__8478_SHARP_){
return (this$["cljsInputElement"] = p1__8478_SHARP_);
});})(G__8480,v,value,on_change))
);
...
var vec__8487 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8487,(0),null);
var id = cljs.core.nth.call(null,vec__8487,(1),null);
var class$ = cljs.core.nth.call(null,vec__8487,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___8492 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___8492 == null)){
} else {
var key_8493 = temp__4661__auto___8492;
(jsprops["key"] = key_8493);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__8495 = (new reagent.impl.template.NativeWrapper());
(G__8495["name"] = c);
...
var len__7923__auto___8500 = arguments.length;
var i__7924__auto___8501 = (0);
while(true){
if((i__7924__auto___8501 < len__7923__auto___8500)){
args__7930__auto__.push((arguments[i__7924__auto___8501]));

var G__8502 = (i__7924__auto___8501 + (1));
i__7924__auto___8501 = G__8502;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8498){
var G__8499 = cljs.core.first.call(null,seq8498);
var seq8498__$1 = cljs.core.next.call(null,seq8498);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__8499,seq8498__$1);
});
...
break;
default:
var G__8506 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__8506;
continue;
...
var n__7737__auto___8509 = a.length;
var i_8510 = (0);
while(true){
if((i_8510 < n__7737__auto___8509)){
(a[i_8510] = reagent.impl.template.as_element.call(null,(a[i_8510])));

var G__8511 = (i_8510 + (1));
i_8510 = G__8511;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__7737__auto___8512 = a.length;
var i_8513 = (0);
while(true){
if((i_8513 < n__7737__auto___8512)){
var val_8514 = (a[i_8513]);
if((cljs.core.vector_QMARK_.call(null,val_8514)) && ((reagent.impl.template.key_from_vec.call(null,val_8514) == null))){
(o["no-key"] = true);
} else {
}

(a[i_8513] = reagent.impl.template.as_element.call(null,val_8514));
...
var ctx = ({});
var vec__8519 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__8519,(0),null);
var derefed = cljs.core.nth.call(null,vec__8519,(1),null);
...
var G__8523 = (cljs.core.count.call(null,argv) - first_child);
switch (G__8523) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__8523){
