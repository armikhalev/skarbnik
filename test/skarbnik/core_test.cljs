  ...
  (testing "2. Should NOT change `sk-id` of any entries"
    (do
      ...
      (let [pre-bank-data @sdb/bank-data
            all-accounts-paths ["/Users/megatron/Documents/clojure-land/skarbnik/fixtures/test-bank"] ;; <-- though it will not be used per se, this just a reminder for what it actually should be
            ...
            credit-meta-data-path "bank-meta-data-path.txt"
            bank-recur-transactions "bank-recurring-transactions.edn"]
        ...
        (helpers/save-account!
         {:all-accounts-paths        all-accounts-paths
          ...
          :recur-data                @sdb/bank-recur-data
